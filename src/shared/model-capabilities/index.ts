...
export {
  getBundledModelCapabilitiesSnapshotForShared as getBundledModelCapabilitiesSnapshot,
};
...
export function getModelCapabilities(
  ...
  return getModelCapabilitiesFromCore({
    ...input,
    bundledSnapshot:
      input.bundledSnapshot ?? getBundledModelCapabilitiesSnapshotForRuntime(),
