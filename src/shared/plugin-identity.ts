export const PLUGIN_NAME = 'extendai-lab';
...
export const CONFIG_BASENAME = 'extendai-lab';
export const LEGACY_CONFIG_BASENAME = 'oh-my-opencode';
export const LOG_FILENAME = 'extendai-lab.log';
export const CACHE_DIR_NAME = 'extendai-lab';
