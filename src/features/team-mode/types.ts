...
const RuntimeStateMemberModelSchema = z
  .object({
    providerID: z.string(),
    modelID: z.string(),
...
const RuntimeStateTmuxLayoutSchema = z
  .object({
...
> = {
  ...
  'deep-worker': {
    verdict: 'conditional',
    rejectionMessage:
      "Agent 'deep-worker' requires high-context model. Use subagent_type: 'orchestrator' instead if teammate permission is not granted.",
  },
  ...
  prometheus: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'prometheus' is plan-mode-only (read-only). Use an orchestrator/executor lane for planning work instead.",
  },
  ...
  explorer: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'explorer' is read-only (codebase search). Use an orchestrator-managed delegation lane instead.",
  },
  librarian: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'librarian' is read-only (docs/code search). Use an orchestrator-managed delegation lane instead.",
  },
  oracle: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'oracle' is read-only (architecture consultation). Use an orchestrator-managed delegation lane instead.",
  },
  designer: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'designer' is read-only (UI/UX design). Use an orchestrator-managed delegation lane instead.",
  },
  fixer: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'fixer' is read-only (quick fixes). Use an orchestrator-managed delegation lane instead.",
  },
  observer: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'observer' is read-only. Use an orchestrator-managed delegation lane instead.",
  },
  council: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'council' is read-only (council member). Use an orchestrator-managed delegation lane instead.",
  },
  councillor: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'councillor' is read-only (council coordinator). Use an orchestrator-managed delegation lane instead.",
  },
  metis: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'metis' is read-only (requirements analysis). Use an orchestrator-managed delegation lane instead.",
  },
  momus: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'momus' is read-only (plan review). Use an orchestrator-managed delegation lane instead.",
  },
  'multimodal-looker': {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'multimodal-looker' is read-only (image/PDF analysis). Use an orchestrator-managed delegation lane instead.",
  },
  reviewer: {
    verdict: 'hard-reject',
    rejectionMessage:
      "Agent 'reviewer' is read-only (code review). Use an orchestrator-managed delegation lane instead.",
  },
} as const;
