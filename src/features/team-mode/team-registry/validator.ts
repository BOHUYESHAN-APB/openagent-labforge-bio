...
const UNKNOWN_SUBAGENT_MESSAGE =
  "Unknown subagent_type '<name>'. Available ELIGIBLE agents: sisyphus, atlas, sisyphus-junior, hephaestus (if D-36 applied). Use an orchestrator-managed delegation lane for read-only agents like oracle, librarian, explore, metis, momus, multimodal-looker.";
