// attachable-session-status.ts - Team Mode tmux subagent module
export function queryWindowState(sessionName: string): unknown {
  return null;
}
...
export function createTrackedSession(sessionId: string): unknown {
